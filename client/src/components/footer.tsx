    ...
    <footer id="contact" className="bg-slate-900 dark:bg-black text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-8 lg:space-y-0">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center space-y-6 lg:space-y-0 lg:space-x-16">
            {/* Company Logo */}
            <div>
              <span className="text-2xl font-semibold text-white">Master Fees</span>
            </div>
          ...
          <div className="flex items-center space-x-6">
            <span className="text-slate-300 text-base">Stay Connected</span>
            <div className="flex space-x-4">
              <a 
                href="#" 
                className="w-10 h-10 bg-slate-800 hover:bg-brand-teal rounded-lg flex items-center justify-center transition-colors duration-200"
                aria-label="Facebook"
              >
