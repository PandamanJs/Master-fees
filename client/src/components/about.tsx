    ...
    <section id="about" className="py-16 sm:py-20 md:py-24 lg:py-28 bg-gradient-to-br from-brand-teal via-brand-teal to-blue-900 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16 sm:mb-20 animate-fade-in-up">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 bg-gradient-to-r from-white via-brand-light-mint to-white bg-clip-text text-transparent">
            Why Choose Us?
          </h2>
          <p className="text-xl sm:text-2xl text-white/90 max-w-4xl mx-auto animate-fade-in-up delay-200 px-4 sm:px-0 leading-relaxed font-medium">
